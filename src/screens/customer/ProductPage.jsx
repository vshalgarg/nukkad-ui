...
//     if (categoryId) {
//       const { items } = await getProductsByCategory(categoryId, nextPage, PAGE_SIZE);
//       if (items?.length) {
...
//       }
//     } else if (searchQuery) {
//       const { items } = await searchProducts(searchQuery, nextPage, PAGE_SIZE);
//       if (items?.length) {
//         setGroupedResults(prev => {
//           const updated = [...prev];
//           if (updated.length > 0) {
...
//       id: categoryId,
//       name: categoryName || 'Category',
//       items, // Directly use the items array
//     };
//     setGroupedResults([category]);
...
//         estimatedItemSize={200} // Crucial for performance - set your average item height
//         ListEmptyComponent={renderEmpty}
//         ListFooterComponent={renderFooter}
//         onEndReached={loadMoreProducts}
//         onEndReachedThreshold={0.2} // More sensitive than FlatList
//         contentContainerStyle={{ paddingBottom: 80, flexGrow: 1 }}
//         showsVerticalScrollIndicator={false}
//         keyboardShouldPersistTaps="handled"
//         nestedScrollEnabled={true}
//         // FlashList specific optimizations:
//         drawDistance={2} // Render items further outside viewport
//         overrideItemLayout={(layout) => {
//           layout.size = 200; // Set if items have fixed height
//         }}
//       />
